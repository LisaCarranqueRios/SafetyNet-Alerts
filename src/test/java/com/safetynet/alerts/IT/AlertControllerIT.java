...
public class AlertControllerIT {
    ...
    public void testGetChildrenAtAddress() throws Exception {
        ...
        MvcResult mvcResultPersonInfo = this.mockMvc.perform(get("/childAlert/1511 Culver St"))
                ...
                .andExpect((ResultMatcher) MockMvcResultMatchers.jsonPath("$.children").exists())
                .andExpect((ResultMatcher) MockMvcResultMatchers.jsonPath("$.houseMembers").exists())
                .andReturn();
     }
    ...
    public void getPersonCoveredByFirestation() throws Exception {
        ...
        MvcResult mvcResultPersonInfo = this.mockMvc.perform(get("/firestation/?stationNumber=30"))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect((ResultMatcher) MockMvcResultMatchers.jsonPath("$.size()").value(3))
                .andExpect((ResultMatcher) MockMvcResultMatchers.jsonPath("$.personsAtFirestation").exists())
                .andExpect((ResultMatcher) MockMvcResultMatchers.jsonPath("$.adultCount").value("1"))
                .andExpect((ResultMatcher) MockMvcResultMatchers.jsonPath("$.childCount").value("0"))
                .andReturn();
    }
